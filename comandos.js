...
Array.prototype.adicionarSubComandos = function(nome, desc,func){
...
var comandos = {
    ...
    "listar" : async (msg, bot, whatsapp)=>{
        ...
        var lista = []
        lista.adicionarSubComandos("pes","mo",async()=>{
            if(texto){
        ...
        lista.adicionarSubComandos("fei","my",async()=>{
            if(texto){
        ...
        lista.adicionarSubComandos("arq","mu",async()=>{
            if(texto){
...
/*lista.adicionarSubComandos("com","",async()=>{
